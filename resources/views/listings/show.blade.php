      ...
      <div class="mt-3 text-center">
        ...
        <div class="px-7 py-2">
          <div class="flex flex-row items-center font-semibold justify-around my-2 my-2">
            <svg class="h-8 w-8 w-1/6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
            ...
            <a class="w-5/6 text-left" href="https://wa.me/{{ $manager->whatsapp }}">{{ $manager->whatsapp }}</a>
          </div>
          <div class="flex flex-row items-center font-semibold justify-around my-2">
            ...
            <a class="w-5/6 text-left" href="https://www.instagram.com/{{ $manager->instagram }}/">{{ $manager->instagram }}</a>
          </div>
          <div class="flex flex-row items-center font-semibold justify-around my-2">
            <svg class="h-8 w-8 w-1/6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
            ...
            <a class="w-5/6 text-left" href="https://www.t.me/{{ $manager->telegram }}/">{{ $manager->telegram }}</a>
          </div>
          <div class="flex flex-row items-center font-semibold justify-around my-2">
            <svg class="h-8 w-8 w-1/6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
            ...
            <span class="w-5/6 text-left">{{ $manager->mobile }}</span>
          </div>
          <div class="flex flex-row items-center font-semibold justify-around my-2">
            <svg class="h-8 w-8 w-1/6" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 392.788 392.788" style="enable-background:new 0 0 392.788 392.788;" xml:space="preserve">
            ...
            <span class="w-5/6 text-left">{{ $manager->phone }}</span>
          </div>
        </div>
