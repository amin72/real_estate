  ...
  <section class="bg-secondary pb-16 px-10 xl:px-32 text-center text-white">
    <div class="flex flex-col lg:flex-row justify-between">
      <div class="w-full lg:w-1/3 px-8">
        ...
        <p class="text-xl px-10">در سطح شهر هر واحد مسکونی که نیاز دارید را می توانید پیدا کنید.</p>
      </div>
      <div class="w-full lg:w-1/3 px-8">
        ...
        <h3 class="py-4 text-2xl font-semibold border-t">فروش و اجاره</h3>
        <p class="text-xl px-10">در سطح شهر هر واحد تجاری و اداری که نیاز داشته دارید را می توانید پیدا کنید.</p>
      </div>
      <div class="w-full lg:w-1/3 px-8">
        ...
        <h3 class="py-4 text-2xl font-semibold border-t">درخواست</h3>
        <p class="text-xl px-10">در سطح شهر هر درخواستی داشته باشید ما برای شما محیا می کنیم.</p>
      </div>
    </div>
  </section>
@endsection
